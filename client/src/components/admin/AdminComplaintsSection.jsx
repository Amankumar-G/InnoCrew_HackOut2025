...
const AdminComplaintsSection = ({ complaints, theme, onComplaintClick }) => {
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          <FaClipboardList className="w-5 h-5 text-purple-500" />
          <span
      ...
      {complaints.length === 0 ? (
        <div className="py-12 text-center">
          <FaClipboardList className="w-16 h-16 mx-auto mb-4 text-gray-400" />
          <p
            className={`text-lg ${
              theme === "dark" ? "text-gray-300" : "text-gray-600"
            }`}
                  ...
                  {complaint.verification?.verificationSummary
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center space-x-1">
                        <FaRecycle className="w-3 h-3 text-green-500" />
